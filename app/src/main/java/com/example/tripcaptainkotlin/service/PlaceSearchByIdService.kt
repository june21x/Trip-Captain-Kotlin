...
import com.example.tripcaptainkotlin.model.PlaceDetailsResponse
 ...
 */
interface PlaceSearchByIdService {
    ...
    companion object {
        ...
        fun create(): PlaceSearchByIdService {
            ...
            val retrofit = Retrofit.Builder()
                ...
                .build()
            return retrofit.create(PlaceSearchByIdService::class.java)
        }
    }
}